...
\begin{table}[h]
\centering
\caption{All conditions. Baseline and GT-anchored use 500 samples (400 train / 100 val);
injection uses 250 samples (200 train / 50 val) and is compared against the matched
250-sample baseline in Section~\ref{sec:results}.
...
\midrule
Qwen2.5-7B  & Baseline (self-score)         & 500 & 0.173 & 0.320        & 0.320 & 0.375 \\
...
and two dataset scales (250 and 500 samples) tested in our study: the
